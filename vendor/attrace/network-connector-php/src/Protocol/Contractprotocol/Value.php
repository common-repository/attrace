 ...
 *
 * Generated from protobuf message <code>attrace.connector.protocol.contractprotocol.Value</code>
 */
class Value extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .attrace.connector.protocol.contractprotocol.Value ListValues = 8;</code>
     */
    private $ListValues;
    /**
     * Int key:val lookups, list-based to have stable serializer.
     *
     * Generated from protobuf field <code>.attrace.connector.protocol.contractprotocol.ListMap ListMap = 9;</code>
     */
     ...
     *     @type bool $Bool
     *     @type string $Blob
     *     @type \Attrace\Connector\Protocol\Contractprotocol\Value[]|\Google\Protobuf\Internal\RepeatedField $ListValues
     *           List of multiple values.
     *     @type \Attrace\Connector\Protocol\Contractprotocol\ListMap $ListMap
     *           Int key:val lookups, list-based to have stable serializer.
     * }
     */
